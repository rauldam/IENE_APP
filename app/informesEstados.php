           ...
           <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div align="center">
                            <h3>Informes detallados por cliente, último estado y sus respectivas observaciones</h3>
    ...
    $('#filtros').on('submit',function(e){
        ...
        if(tabla){
            t = $('#tabla').DataTable( {
                ...
                "ajax":"../php/datatables/server_processing_estados.php?estado="+datos[1]['value']+"&fecha="+dataRange+"&prod="+datos[0]['value']+"&red="+datos[2]['value']+"&fase="+datos[4]['value']+"&tec="+datos[5]['value'],
                "language": {
            ...
            console.log(tabla);
            console.log(t);
            t.ajax.url("../php/datatables/server_processing_estados.php?estado="+datos[1]['value']+"&fecha="+dataRange+"&prod="+datos[0]['value']+"&red="+datos[2]['value']+"&fase="+datos[4]['value']+"&tec="+datos[5]['value']).load();
        }
    });
  </script>
</html>