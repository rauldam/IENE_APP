           ...
           <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div align="center">
                            <h3>Informes avanzados por estado</h3>
                            <small>Desde aquí podrás obtener informes avanzado de los productos solo debes crear el filtro que desees</small>
                        </div>
                        <hr>
                    </div>
                    <div align="center">
                       ...
                       <form class="form-sample" id="filtros">
                        <select class="form-control-sm" id="estado" name="estado" required>
                            <option selected value="all">Ultimo estado</option>
						...
						<select class="form-control-sm" id="estadoDos" name="estadoDos" required>
                            <option selected value="all">Estado que ha pasado</option>
                            <option value="pendiente">Pendiente</option>
                            <option value="hecho">Hecho</option>
                            <option value="incidencia">Incidencia</option>
                            <option value="incidencia_resuelta">Incidencia Resuelta</option>
    ...
    $('#filtros').on('submit',function(e){
        ...
        if(tabla){
            t = $('#tabla').DataTable( {
                ...
                "ajax":"../php/datatables/server_processing_estados_avanzados.php?estado="+datos[0]['value']+"&estadoDos="+datos[1]['value']+"&red="+datos[2]['value']+"&range="+dataRange,
                "language": {
            ...
            console.log(tabla);
            console.log(t);
            t.ajax.url("../php/datatables/server_processing_estados_avanzados.php?estado="+datos[0]['value']+"&estadoDos="+datos[1]['value']+"&red="+datos[2]['value']+"&range="+dataRange).load();
        }
    });
  </script>
</html>