           ...
           <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div align="center">
                            <h3>Informes de productos explicados</h3>
                            <small>Desde aquí podrás obtener informes detallados de explicados</small>
                        </div>
                        <hr>
                    </div>
                    <div align="center">
    ...
    $('#filtros').on('submit',function(e){
        ...
        if(tabla){
            t = $('#tabla').DataTable( {
                ...
                "ajax":"../php/datatables/server_processing_explicacion.php?prod="+datos[0]['value']+"&fecha="+dataRange,
                "language": {
            ...
            console.log(tabla);
            console.log(t);
            t.ajax.url("../php/datatables/server_processing_explicacion.php?prod="+datos[0]['value']+"&fecha="+dataRange).load();
        }
    });
  </script>
</html>