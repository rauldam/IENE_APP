...
<body>
           ...
           <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div align="center">
                            <h3>Informes detallados por cliente, último estado y SIN respectivas observaciones</h3>
                            <small>Desde aquí podrás obtener informes detallados para gran volumen de datos (Trimestrales, Cuatrimestrales ... Anuales)</small>
                        </div>
                        <hr>
                    </div>
                    <div align="center">
                       ...
                       <select class="form-control-sm" id="productos" name="productos" required>
                        ...
                        <select class="form-control-sm" id="fase" name="fase" required>
                            <option value="all">Tipo de fase</option>
                            <option value="estandar">Estandar/Bonificado</option>
                            <option value="privado">Privado</option>
                        </select>
                        <?php
                            if($rols[0]['nombre'] == "ADMIN" || $rols[0]['nombre'] == "ROOT"){
                                echo '<select class="form-control-sm" name="tec" required><option value="all">Técnicos</option>';
                        ...
                        ?>
						 <select class="form-control-sm" id="anyo" name="anyo" required>
                            <option value="all">Año actual</option>
  ...
  <script>
    ...
    $('#filtros').on('submit',function(e){
        ...
        var dataRange = datos[3]['value'].replace(" - ","' AND '");
        dataRange = dataRange.replace("2","'2");
        console.log(datos);
        var tamanyo = datos.length;
        if(tamanyo == 5){
            datos[5] = {name:"tec",value:"all"};
            console.log(datos);
        }
        ...
        if(tabla){
            t = $('#tabla').DataTable( {
                ...
                "ajax":"../php/datatables/server_processing_informe_anual.php?estado="+datos[1]['value']+"&fecha="+dataRange+"&prod="+datos[0]['value']+"&red="+datos[2]['value']+"&fase="+datos[4]['value']+"&tec="+datos[5]['value']+"&anyo="+datos[6]['value'],
                "language": {
            ...
            console.log(tabla);
            console.log(t);
            t.ajax.url("../php/datatables/server_processing_informe_anual.php?estado="+datos[1]['value']+"&fecha="+dataRange+"&prod="+datos[0]['value']+"&red="+datos[2]['value']+"&fase="+datos[4]['value']+"&tec="+datos[5]['value']+"&anyo="+datos[6]['value']).load();
        }
    });
  </script>
</html>