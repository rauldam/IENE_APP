           ...
           <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div align="center">
                            <h3>Buscar productos por contrato</h3>
                            <small>Desde aquí podrás buscar productos por número de contrato y cambiarle el tipo de producto</small>
                        </div>
                        <hr>
                    </div>
                    <div align="center">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-body">
                        <h3>Use los selectores para modificar el producto y su fase</h3>
                        <hr>
                        <form class="forms-sample" id="formmodal">
                            <input type="hidden" id="id" name="id">
                            <div class="form-group row">
                                <div class="col-md-6 mb-3">
                                        Producto asignado actualmente
                                </div>
                                
                                <div class="col-md-6 mb-3">
                                    <select class="form-control-sm" id="selProds" name="selProds" required>
                                        <?php
                                            for($i = 0; $i < count($tipo_productos); $i++){
                                              echo '<option id="'.$tipo_productos[$i]['tipo_producto'].'" value="'.$tipo_productos[$i]['tipo_producto'].'">'.$tipo_productos[$i]['tipo_producto'].'</option>';
                                            }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 mb-3">
                                   Tipo de fase asignada acutalmente
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group row">
                                 <div align="right">
                                    <button class="btn btn-success" type="button" id="btnEnviar" onclick="enviarInformacion()">Actualizar</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    $('#filtros').on('submit',function(e){
        ...
        if(tabla){
            t = $('#tabla').DataTable( {
                ...
                "ajax":"../php/datatables/server_processing_productos.php?prod="+datos[0]['value'],
                "language": {
            ...
            console.log(tabla);
            console.log(t);
            t.ajax.url("../php/datatables/server_processing_productos.php?prod="+datos[0]['value']).load();
        }
    });
      ...
      $('#tabla tbody').on('dblclick', 'tr', function () {
        ...
        //console.log(data);
          $('#selProds').val(data['producto']);
          $('#fase').val(data['fase']);
          $('#id').val(data['idproductos']);
          $('#modal').modal('toggle');
      ...
      function enviarInformacion(){
          ...
          $.ajax({
              type:"GET",
              url:"../php/actualizaProd.php?id="+data[0]['value']+"&prod="+data[1]['value']+"&fase="+data[2]['value'],
