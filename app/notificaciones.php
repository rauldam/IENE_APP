...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div align="center">
                            ...
                            <small>Desde aquí podrás ver todas las notificaciones</small>
                        </div>
                        <hr>
                    </div>
                    <div align="center">
                       ...
                       <form class="form-sample" id="filtros">
                        <select class="form-control-sm" id="cliente" onchange="controlSelect(this.value)" name="cliente" required>
                            <option selected value="s">Resueltas</option>
                            <option value="n">No resueltas</option>
                        </select>
  ...
  <script>
      ...
      var url = "../php/datatables/server_processing_notify.php?clientes=s";
     // url = url+fecha;
    ...
    $('#filtros').on('submit',function(e){
        ...
        tabla.ajax.url("../php/datatables/server_processing_notify.php?clientes="+datos[0]['value']).load();
    });
  </script>
</html>
