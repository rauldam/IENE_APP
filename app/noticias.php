...
<body>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-10">
                        <div align="center">
                            <h3>Noticias</h3>
                            <small>Desde aquí podrás ver todas las noticias publicadas, editarlas y añadir nuevas</small>
                        </div>
                       
                    </div>
                    <div class="col-2">
                        <div align="right">
                            <button class="btn btn-success" onclick="anyadir()">Añadir</button>
                        </div>
                    </div>
                    <hr>
  ...
  <script>
      var tabla = null;
      var url = "../php/datatables/server_processing_noticias.php";
    ...
    $('#tabla tbody').on('dblclick', 'tr', function () {
        ...
        var idnoticia = data['id'];
        window.location.href = "noticia.php?editar=si&idnoticia="+idnoticia;
